...
def main(args):
    ...
    # data = [(2+i,"rtsp://admin:Comit123@192.168.6.108:554") for i in range(7)]
    # data = [(2+i, "file:///media/ngoc-thanhluu/data/thanhlnbka/Projects/behaviorhuman/videos/video_inputdemo/intrusion.mp4") for i in range(5)]
    cam_id = [1,3,5]
    data = [(3,"rtsp://admin:Comit2022@192.168.6.122:554/profile1/media.smp"),(4,"rtsp://admin:Comit123@192.168.6.108:554")]
